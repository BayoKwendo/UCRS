...
if(isset($_SESSION['userId'])){
 echo  '<script> window.location="adminreceived.php";</script>';
	...
	if(empty($username) || empty($password)) {
		...
		if($result->num_rows == 1) {
			...
			if($mainResult->num_rows == 1) {
				$_SESSION['userId'] = $mainResult->fetch_assoc();
				 echo  '<script> window.location="adminreceived.php";</script>';
...
<body>
	<div class="container">
         <h5 style="color: black" class="text-center"><b><u>Welcome to the Admin Panel</u></b></h5>
		<div class="row vertical">
			<div class="col-md-5 col-md-offset-4">

				<div class="panel panel-info">
					<div class="panel-heading">
						 <a href="home.php" class="color-primary pull-right"><i class="glyphicon glyphicon-hand-left"></i> home</a>
